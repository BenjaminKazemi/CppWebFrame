...
namespace odb
{
  ...
  struct access::object_traits_impl< ::person, id_sqlite >::container_statement_cache_type
  {
  ...
  schema_catalog_entry_person_ (
    id_sqlite,
    "",
    &access::object_traits_impl< ::person, id_sqlite >::create_schema);
